...
const TestimonialData = [
  {
    ...
    name: "Ketut Susilo",
    country: "Indonesia",
    text: "I lost 7 kg in 2 months without giving up my favorite foods. The meal plans are so easy to follow!.",
  ...
  },
  {
    ...
    name: "Juliana Silva",
    country: "Portugal",
    text: "Being diabetic, I always struggled with food choices. This app made it simple and effective.",
  ...
  },
  {
    ...
    name: "Drew Feig",
    country: "Canada",
    text: "My energy levels are up, workouts feel stronger, and I finally understand what my body needs.",
  ...
  id: 4,
    name: "Karan",
    country: "India",
    text: "I used to skip meals due to PCOS issues. Now, my cycles are regular and I feel so much healthier.",
    img: "https://picsum.photos/101/101",
  },
  {
    id: 5,
    name: "Sneha",
    country: "India",
    text: "Tracking calories and macros used to be confusing. This made it effortless and fun",
    img: "https://picsum.photos/102/102",
  },
  {
    id: 6,
    name: "Vikram",
    country: "Canada",
    text: "The personalized diet plans are a game changer — no crash diets, just real food and real results.",
    img: "https://picsum.photos/103/103",
  },
];
